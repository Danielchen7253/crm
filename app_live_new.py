...
</head><body><header class="top"><a class="back" href="/">&lsaquo; CRM</a><h1>系统设置</h1></header><main class="wrap"><div class="card"><h2>系统管理</h2><div class="muted">这里会作为后续配置中心：固定回复、AI训练资料、自动回复开关、Meta / WhatsApp 接口状态、系统权限。</div></div><section class="grid"><div class="card"><h2>固定回复</h2><div class="muted">下一步把发货时间、提货地址、售后话术集中在这里编辑。</div></div><div class="card"><h2>AI 训练资料</h2><div class="muted">后面可以上传你的谈判话术、常见问题、产品资料，让 AI 学你的回复方式。</div></div><div class="card"><h2>渠道配置</h2><div class="muted">管理 Messenger、WhatsApp、Marketplace、Instagram、短信、Shopify 等接入状态。</div><a class="button" href="/?view=integrations">打开接口管理</a></div><div class="card"><h2>安全</h2><div class="muted">当前 CRM 首页和系统设置均已启用密码锁。</div></div></section></main></body></html>
"""
