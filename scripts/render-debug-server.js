...
const startLogPath = path.join(process.cwd(), "render-start.log");

http
  .createServer((req, res) => {
    if (req.url === "/") {
      res.writeHead(200, { "content-type": "text/plain; charset=utf-8" });
      res.end("render debug server\nopen /render-build.log or /render-start.log\n");
      return;
    }
    ...
    if (req.url === "/render-start.log") {
      res.writeHead(200, { "content-type": "text/plain; charset=utf-8" });
      res.end(fs.existsSync(startLogPath) ? fs.readFileSync(startLogPath, "utf8") : "render-start.log not found");
      return;
    }
